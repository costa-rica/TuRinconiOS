...
extension Resources.Fonts {
    enum Weight: String {
        ...
        case regular = "Rockwell_tu"
        case semibold = "Rockwell-Bold_tu"
        case italic = "RobotoSlab-Thin"
...
//            return UIFont(name: Resources.Fonts.Weight.semibold.rawValue, size: ofSize)!
    ...
    @objc class func mySystemFont(ofSize size: CGFloat) -> UIFont {
        //MARK: This seems to always have a problem, uncomment if we're going to fix it <--
//        print("* error here: \(Resources.Fonts.Weight.light.rawValue)")
